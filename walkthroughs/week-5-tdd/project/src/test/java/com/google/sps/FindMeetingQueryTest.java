...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void onlyOptionalAttendeesWithGapsInSchedule() {
    // There are gaps in the optional attendee's schedules.
    //
    // Events  : |--A--|---|-B--|--A---|
    // Day     : |---------------------|
    // Options :       |---|
    ...
    Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartEnd(TIME_0830AM, TIME_0900AM, false),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartEnd(TIME_1000AM, TIME_1030AM, true),
            Arrays.asList(PERSON_A))),
    ...
    Collection<TimeRange> expected = Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY,TIME_0830AM,false),
        TimeRange.fromStartEnd(TIME_0900AM, TIME_1000AM, true), TimeRange.fromStartEnd(TIME_1030AM, TIME_1100AM, true),
  ...
  @Test
  public void onlyOptionalAttendeesWithNoGapsInSchedule() {
    // There are no gaps in the attendee's schedules.
    //
    // Events  : |--A--|--B--|----A----|
    // Day     : |---------------------|
    // Options : 
